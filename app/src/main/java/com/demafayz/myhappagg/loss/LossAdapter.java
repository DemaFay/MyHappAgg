 ...
 */
public class LossAdapter extends ArrayAdapter<LossItem> {
    private List<LossItem> list = new ArrayList<LossItem>();
    ...
    public LossAdapter(Context context, int resource, List<LossItem> objects) {
